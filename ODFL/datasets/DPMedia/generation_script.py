...
def generate_dbpedia14(
    ...
    # Load DBPedia14 dataset from Hugging Face
    dataset = load_dataset('dbpedia_14')

    # Save full dataset to 'centralised' folder
    dataset.save_to_disk(os.path.join(os.getcwd(), 'centralised', 'DBPedia14'))
    ...
    save_custom_dataset(
        path=os.path.join(os.getcwd(), 'decentralised', 'DBPedia14'),
        dataset=data_split
    )
