...
def launch_centralised_mnist(
    ...
    This function sets up and runs a training loop for a centralized (non-federated) MNIST model.
    ...
    dataset_directory = os.path.join(DATASET_PATH, 'centralised', 'MNIST')
    general_directory = os.path.join(RESULTS_PATH, 'centralised', 'MNIST', timestamp)
    results_directory = os.path.join(RESULTS_PATH, 'centralised', 'MNIST', timestamp, 'results')
    models_directory = os.path.join(RESULTS_PATH, 'centralised', 'MNIST', timestamp, 'models')
